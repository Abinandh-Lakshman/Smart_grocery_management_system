...
def hide():
    openeye.config(file="C:\\Users\\Abinandh_Lakshman\\Downloads\\closeye (1).png")
    password.config(show="*")
    eyebutton.config(command=show)

def show():
    openeye.config(file="C:\\Users\\Abinandh_Lakshman\\Downloads\\openeye.png")
    password.config(show='')
...
# Background Image
background = ImageTk.PhotoImage(file="A:\\project\\WhatsApp Image 2025-02-28 at 12.32.40_ac49370a.jpg")
